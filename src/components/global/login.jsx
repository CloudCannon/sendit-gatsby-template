                        ...
                        <div className="sing-up-body">
                            ...
                            <form className="sing-up-items row gy-4 gx-3">
                                <div className="col-md-12">
                                    ...
                                    <input type="text" className="form-control" id="fullName" placeholder={block.form.fullname.placeholder} />
                                </div>
                                <div className="col-md-12">
                                    <label for="pEmailId" className="form-label">{block.form.email.heading}</label>
                                    <input type="email" className="form-control" id="pEmailId" placeholder={block.form.email.placeholder} />
                                </div>
                                <div className="col-6">
                                ...
                                <div className="col-md-12">
                                    <button type="submit" className="btn btn-submit  w-100">{block.form.log_in_button.text}</button>
                                </div>
                                ...
                                <div className="col-md-12">
                                    <a href={block.form.sign_up_button.link} className="create-account">{block.form.sign_up_button.text}</a>
                                </div>
                            </form>
                    </div>
                </div>
